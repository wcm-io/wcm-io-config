...
public class ApplicationImplementationPickerTest {
  ...
  private static final Application APP_1 = new ApplicationImpl(APP_ID_1, null);
  private static final Application APP_2 = new ApplicationImpl(APP_ID_2, null);
  ...
  @Model(adaptables = Resource.class, adapters = Comparable.class)
  @io.wcm.config.api.annotations.Application(APP_ID_1)
  ...
  @Model(adaptables = Resource.class, adapters = Comparable.class)
  @io.wcm.config.api.annotations.Application(APP_ID_2)
