...
public class ParameterPersistenceImpl implements ParameterPersistence {
  ...
  @Override
  public void setParameterValues(String configurationId, Map<String, Object> values) {
    // TODO: sseifert@sseifert implement
  }

  @Override
  public void setParameterValues(String configurationId, Map<String, Object> values, boolean mergeWithExisting) {
    // TODO: sseifert@sseifert implement
  }
